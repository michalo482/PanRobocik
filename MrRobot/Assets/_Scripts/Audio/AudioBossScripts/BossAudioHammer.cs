...
public class BossAudioHammer : MonoBehaviour  
{
    ...
    public void PlayHammerAttackSFX()
    {
        ...
        {
            hammerSource.volume = PlayerPrefs.GetFloat("SFXVolume", 1.0f);  // Ustawienie g³oœnoœci na podstawie SFX
            hammerSource.Play();
        }
    }
    ...
    public void PlayHammerAttack2SFX()
    {
        ...
        {
            hammerSource2.volume = PlayerPrefs.GetFloat("SFXVolume", 1.0f);  // Ustawienie g³oœnoœci na podstawie SFX
            hammerSource2.Play();
        }
    }
    ...
    public void PlayHammerAttack3SFX()
    {
        ...
        {
            hammerSource3.volume = PlayerPrefs.GetFloat("SFXVolume", 1.0f);  // Ustawienie g³oœnoœci na podstawie SFX
            hammerSource3.Play();
        }
    }
    ...
    public void PlayUltiHammerSFX()
    {
        ...
        {
            ultihammerSource.volume = PlayerPrefs.GetFloat("SFXVolume", 1.0f);  // Ustawienie g³oœnoœci na podstawie SFX
    ...
    public void PlayJumpAttack3SFX()
    {
        ...
        {
            jumpAttackSource3.volume = PlayerPrefs.GetFloat("SFXVolume", 1.0f);  // Ustawienie g³oœnoœci na podstawie SFX
